...
export const Home: Translations['Home'] = {
  Hero: {
  ...
  WhyOlafut: {
    ...
    features: {
      needsMoreThanPromises: 'El Futbol Femenil necesita más que promesas.',
      imagineAPlace:
        'Imagina un lugar donde el fútbol femenil no compite, sino que colabora.',
      womenAreTheProtagonists:
  ...
  Initiatives: {
    ...
    ctaText: '¡No te pierdas la oportunidad!',
  },
};
