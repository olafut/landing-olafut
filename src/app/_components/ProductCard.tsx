  ...
  return (
    ...
    >
      ...
      {!!imgProps?.src && !!imgProps.alt && (
        <div className="relative w-full h-auto max-w-full mx-auto aspect-3/4 lg:aspect-4/3 rounded-lg overflow-hidden group/image">
          {/* Overlay en hover */}
